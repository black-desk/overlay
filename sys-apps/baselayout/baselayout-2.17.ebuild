...
src_prepare() {
	...
	if use prefix; then
		...
		echo PATH=/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin >> etc/env.d/99host
		echo ROOTPATH=/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin >> etc/env.d/99host
		echo MANPATH=/usr/local/share/man:/usr/share/man >> etc/env.d/99host
